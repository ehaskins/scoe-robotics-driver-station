...
Public Class Joystick
    ...
    Dim _analogInputs(6) As Byte
    Dim _digitalInputs(16) As Boolean

    Public Sub Parse(ByVal reader As BinaryReader)
        For i = 0 To 5
            AnalogInputs(i) = ((reader.ReadByte() - 128) / 128) * 1000
        Next
    ...
    Public Function GetBytes() As Byte()
        ...
        Return data
    End Function
    Public Property AnalogInputs() As Byte()
        Get
